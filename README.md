...
<img width="70%" alt="Picture 1" src="https://github.com/user-attachments/assets/d68d0cc7-de9e-4220-a99e-22d209f8f8a3" />
...
python main.py
```
MacOS(without stable GUI)
```bash
python main_for_MacOS.py
```
